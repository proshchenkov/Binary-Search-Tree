...
public class Vector2D {
     ...
     */
    public static Vector2D add(@NotNull Vector2D v1, @NotNull Vector2D v2) {
        return v1.add(v2);
    }
     ...
     */
    public Vector2D mull(@NotNull Vector2D v) {
        return new Vector2D(x * v.x, y * v.y);
    }
     ...
     */
    public static Vector2D mull(@NotNull Vector2D v1, @NotNull Vector2D v2) {
        return v1.mull(v2);
    }
     ...
     */
    public static Vector2D sub(@NotNull Vector2D v1, @NotNull Vector2D v2) {
        return v1.sub(v2);
    }
     ...
     */
    public static Vector2D div(@NotNull Vector2D v1, @NotNull Vector2D v2) {
        return v1.div(v2);
    }
     ...
     * @return масштабированный вектор
     */
    public static Vector2D scale(@NotNull Vector2D v, double d) {
        return v.scale(d);
    }
     ...
     * @return вектор направленный в противоположную сторону(развернутый на 180 градусов), такой же длинны
     */
    public static Vector2D opposite(@NotNull Vector2D v) {
        return v.scale(-1);
    }
     ...
     * @return вектор повернутый на угол а
     */
    public static Vector2D rotate(@NotNull Vector2D v, double a) {
        return v.rotate(a);
    }
     ...
     * @return длинна вектора
     */
    public static double length(@NotNull Vector2D v) {
        return v.length();
    }
     ...
     * @return вектор длинны 1 смотрящий в том же направлении что и данный
     */
    public static Vector2D normalize(@NotNull Vector2D v) {
        return v.normalize();
    }
     ...
     */
    public double scalarProduct(@NotNull Vector2D v) {
        return x * v.x + y * v.y;
    }
     ...
     */
    public static double scalarProduct(@NotNull Vector2D v1, @NotNull Vector2D v2) {
     ...
     */
    public double angle(@NotNull Vector2D v) {
     ...
     */
    public static double angle(@NotNull Vector2D v1, @NotNull Vector2D v2) {
        return v1.angle(v2);
    }
